public String[] tiposPokemon = {
    ...
    public String[] MENSAJES_EFICACIAS = {
                                                    "NO ES MUY EFICAZ", 
                                                    "NEUTRO", 
                                                    "ES MUY EFICAZ", 
                                                    "NO AFECTA",
    ...
    */
    ...
    public int INDICE_NME=0;
    public int INDICE_NEUTRO=1;
    public int INDICE_EME=2;
    public int INDICE_NA=3;
    public int INDICE_DE=4;
    public int INDICE_DNE=5;
    
    /*Eficiacias*/
    
    public double EFICACIA_DE=4; /*DOBLEMENTE EFICAZ*/
    public double EFICACIA_EME=2; /*ES MUY EFICAZ*/
    public double EFICACIA_NEUTRO=1;
    public double EFICACIA_NME=0.5; /*NO ES MUY EFICAZ*/
    public double EFICACIA_DNE=0.25; /*DOBLEMENTE NO ES EFICAZ*/
    public double EFICACIA_NA=0;  /*NO AFECTA*/
